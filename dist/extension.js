...
var ChatWebviewProvider = class _ChatWebviewProvider {
  ...
  getHtmlForWebview(webview) {
    return `
      ...
      <body>
        <div class="header">
          <h2>\u{1F4AC} AI Chat Assistant</h2>
        </div>
        ...
        <script>
          ...
          function addMessage(text, type) {
            ...
            if (type === 'ai-loading') {
              messageDiv.innerHTML = '<span class="icon">\u{1F916}</span><div class="message-content"><div class="loading"><span></span><span></span><span></span></div></div>';
            } else {
  ...
  async getHtmlForWebview(webview) {
    ...
    return `
      ...
      <body>
        ...
        <div class="section">
          <div class="section-title">\u{1F4C8} Recent Activity</div>
          <div class="chart-container">
            <div class="bar">
